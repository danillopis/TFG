...
Además, también están disponibles tanto los ficheros con los pesos de las DNN entrenadas (best_small.keras...) como la DNN utilizada para el experimento (modelo_mejor.h5) y la tabla de resultados de los modelos en formato CSV.
